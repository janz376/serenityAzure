...
public class uso_veh_mant_soap2 implements Task{
	
	private String item;
//	private String item2;
	
	public uso_veh_mant_soap2(String item){
...
//        	    Switch.toFrame("shellTab337"),
        	    Enter.theValue(item)
				.into("/html/body/div/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[5]/td/form/table/tbody/tr[3]/td[2]/input")
//				.thenHit(RETURN)
				);
...
//	}
	...
	public static uso_veh_mant_soap2 called(String item) {
		
		return Instrumented.instanceOf(uso_veh_mant_soap2.class).withProperties(item);
	}
}
